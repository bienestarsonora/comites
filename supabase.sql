-- Plataforma de Comités de Contraloría y Participación Social
...
create table if not exists public.contact_requests (
  id uuid primary key default gen_random_uuid(),
  name text not null,
  committee_type text not null check (committee_type in ('Contraloría Social','Participación Social')),
...
('CPS','Comité de Participación Social El Mirador','Hermosillo','El Mirador','',8,'2026-02-15'::date,29.118,-110.993,'Activo','','true'::boolean),
('CPS','Comité de Participación Social Las Cuevitas','Hermosillo','Las Cuevitas','',9,'2026-02-28'::date,29.064,-111.012,'Activo','','true'::boolean),
('CPS','Comité de Participación Social Villas del Real','Hermosillo','Villas del Real','',7,'2026-03-14'::date,29.129,-110.947,'Activo','','true'::boolean),
('CPS','Comité de Participación Social Cañada de los Negros','Hermosillo','Cañada de los Negros','',7,'2026-03-28'::date,29.083,-110.928,'Activo','','true'::boolean),
('CPS','Comité de Participación Social Internacional','Hermosillo','Internacional','',10,'2026-04-11'::date,29.096,-111.018,'Activo','','true'::boolean),
('CPS','Comité de Participación Social Solidaridad','Hermosillo','Solidaridad','',8,'2026-04-26'::date,29.132,-111.002,'Activo','','true'::boolean),
('CPS','Comité de Participación Social Nuevo Hermosillo','Hermosillo','Nuevo Hermosillo','',7,'2026-05-10'::date,29.008,-110.934,'Activo','','true'::boolean),
('CPS','Comité de Participación Social Los Olivos','Hermosillo','Los Olivos','',8,'2026-05-23'::date,29.024,-110.979,'Activo','','true'::boolean)
